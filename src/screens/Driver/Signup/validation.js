...
const validationSchema = Yup.object().shape({
  username: Yup.string().label('Username').required().min(6, 'Must have at least 6 characters'),
  ...
  occupation: Yup.string().label('Primary Occupation').required().min(2, 'Must have at least 2 characters'),
});
