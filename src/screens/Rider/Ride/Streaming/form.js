...
const video = require('../../../../assets/kids-ride.mp4');
  ...
  <Formik
    ...
    {({ handleChange, values, handleSubmit, errors, isValid, isSubmitting, touched, handleBlur }) => (
      <Fragment>
        ...
        <View style={{ flexDirection: 'column', marginTop: 210 }}>
          <IconContainer>
        ...
        <ButtonContainer>
          <FormButton title="Report Issue" textColor="white" disabled={false} loading={false} />
        </ButtonContainer>
      </Fragment>
    )}
  </Formik>
