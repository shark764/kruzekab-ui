...
export default class RideAccepted extends Component {
  state = {};
  ...
  static navigationOptions = ({ navigation, navigation: { state } }) => {
    return {
      ...
      headerBackground: () => (
        <Image style={{ width: '100%', height: 450 }} source={require('../../../../assets/map2.png')} />
      )
    };
  };
  ...
  componentDidMount() {
    setTimeout(() => {
      this._navigateTo('RideArrived', { userType: 'rider' });
    }, 5000);
  }
  ...
  render() {
    console.log('Nav param', 'RideAccepted', this.props.navigation.getParam('userType', null));
